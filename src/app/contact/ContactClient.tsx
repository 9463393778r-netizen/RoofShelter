...
export default function ContactClient() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Email sending handled server-side
    } finally {
      form.reset()
  ...
  return (
    <>
      <style jsx>{`
        ...
        .cta-icon i { font-size: 40px; color: white; }
        .cta-content h2 {
          font-size: 56px;
          font-weight: 900;
          margin-bottom: 25px;
        ...
        .cta-subtitle { font-size: 22px; margin-bottom: 50px; opacity: 0.9; }
        .cta-buttons {
          display: flex;
          gap: 30px;
          justify-content: center;
        ...
        @media (max-width: 768px) {
          .contact-section { padding: 20px 0; background: transparent; }
          .contact-wrapper { grid-template-columns: 1fr; gap: 20px; padding: 0 15px; }
          .contact-info { padding: 25px; border-radius: 25px; }
          .contact-info h2 { font-size: 24px; text-align: center; }
          .contact-form { padding: 25px; border-radius: 25px; }
          .contact-form h2 { font-size: 24px; text-align: center; }
          .form-row { grid-template-columns: 1fr; }
          .btn-submit { width: 100%; padding: 18px; border-radius: 15px; }
          .map-section { padding: 20px 0; }
          .map-container { height: 250px; margin: 0 15px; border-radius: 25px; }
          .cta-section { padding: 40px 0; margin: 20px 15px; border-radius: 30px; }
          .cta-content h2 { font-size: 28px; }
          .cta-buttons { flex-direction: column; gap: 15px; }
          .btn-cta-primary, .btn-cta-secondary { width: 100%; padding: 18px 25px; font-size: 16px; border-radius: 15px; justify-content: center; }
        }
      `}</style>
                ...
                <div className="contact-info">
                  ...
                  <address style={{ fontStyle: 'normal' }}>
                    ...
                    <div className="contact-item">
                      ...
                      <div className="contact-details">
                        <h3>Phone Number</h3>
                        <p><a href="tel:+61434115094" style={{ color: 'inherit', textDecoration: 'none' }}>+61 434 115 094</a></p>
                      </div>
                    </div>
                    ...
                    <div className="contact-item">
                      ...
                      <div className="contact-details">
                        <h3>Email Address</h3>
                        <p><a href="mailto:parmindersinghasr@yahoo.com" style={{ color: 'inherit', textDecoration: 'none' }}>parmindersinghasr@yahoo.com</a></p>
                      </div>
                    </div>
            ...
            <div className="container">
              <div className="map-container">
                <iframe
                  ...
                  title="RoofShelter location – 2/12-16 Prospect Street, Rosehill NSW 2142"
            ...
            <div className="container">
              <div className="cta-content">
                ...
                <div className="cta-buttons">
                  <a href="tel:+61434115094" className="btn-cta-primary" aria-label="Call RoofShelter now">
                    <i className="fas fa-phone" aria-hidden="true"></i>
                    Call Now: +61 434 115 094
                  </a>
                  <a href="mailto:parmindersinghasr@yahoo.com" className="btn-cta-secondary" aria-label="Send email to RoofShelter">
                    <i className="fas fa-envelope" aria-hidden="true"></i>
                    Send Email
                  </a>
                </div>
