            ...
            <div className="container">
              <div className="intro-wrapper">
                ...
                <div className="intro-image">
                  <Image src="/images/about2.png" alt="RoofShelter professional roofing team at work in Sydney NSW" width={600} height={500} />
                  <div className="intro-btn">
                    <a href="/contact" className="btn-primary" aria-label="Get a free roofing quote">Get Free Quote</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="team-grid">
                <div className="team-member">
                  <div className="team-photo">
                    <Image src="/images/blog/10009.jpg" alt="John Smith - Lead Roofing Specialist at RoofShelter" width={400} height={300} />
                  </div>
                ...
                <div className="team-member">
                  <div className="team-photo">
                    <Image src="/images/blog/10009.jpg" alt="Mike Johnson - Project Manager at RoofShelter" width={400} height={300} />
                  </div>
                  <div className="team-info">
                    <h3>Mike Johnson</h3>
                    <p>Project Manager</p>
                ...
                <div className="team-member">
                  <div className="team-photo">
                    <Image src="/images/blog/10009.jpg" alt="Sarah Wilson - Quality Inspector at RoofShelter" width={400} height={300} />
                  </div>
                  <div className="team-info">
                    <h3>Sarah Wilson</h3>
